...
public class BallDetect {
	...
	public void process(Mat source0) {
		...
		double[] hsvThresholdSaturation = {149.82013550164888, 228.89078498293517};
		double[] hsvThresholdValue = {111.6007223403711, 255.0};
	...
	public MatOfKeyPoint findBlobsOutput() {
		System.out.print(findBlobsOutput);
	...
	private void findBlobs(Mat input, double minArea, double[] circularity,
		...
		FastFeatureDetector blobDet = FastFeatureDetector.create(FastFeatureDetector.THRESHOLD );
		try {
